...
public class LRULinkedHashMapTest {
    ...
    public void intCache1() {
        ...
        LRULinkedHashMap<Integer, Integer> cache = new LRULinkedHashMap<>(2);
        cache.put(1, 1); // 1
        cache.put(2, 2); // 2 1
    ...
    public void testCache3() {
        ...
        LRULinkedHashMap<Profile, List<Music>> cache = new LRULinkedHashMap<>(2);
    ...
    public void testCache4() {
        ...
        cache.put(4, 1); //
        assertNull(cache.get(1)); // 4 3 -> -1
        assertEquals(3, (int) cache.get(2)); // 3 4 -> 3
    }
}